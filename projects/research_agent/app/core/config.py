...
from packages.core.config import get_config as get_base_config, AppConfig as BaseAppConfig, ToolConfiguration
...
class ResearchToolConfiguration(ToolConfiguration):
...
class ResearchAgentConfig(BaseAppConfig):
    ...
    tools: ResearchToolConfiguration = ResearchToolConfiguration()
