...
> "I am an AI Architect with a strong foundation in enterprise software engineering (.NET/Java/AWS). Over the last few years, I’ve specialized in productionizing RAG and Agentic systems. At EPM, I architected 'MaxAI,' an enterprise platform that used LangGraph to move beyond simple chat into complex, multi-agent workflows. I focus on building systems that aren't just intelligent, but are robust, observable, and scalable."
